# -*- coding: utf-8 -*-
# @Time : 2021/10/12 10:27
# @Author : Z.chang
# @FileName: resnet_50_101.py
# @Software: PyCharm
# @Description：Encoder for few shot segmentation (Resnet 50 and 101)
import torch
...
def _resnet(arch, block, layers, pretrained, **kwargs):
    ...
    if pretrained:
        state_dict = torch.load("./pretrained_model/%s.pth" % arch)
